...
#ifdef QSEVEN
#define CONFIG_MX6S_SECO_Q7
#endif
#ifdef UQSEVEN
#define CONFIG_MX6S_SECO_UQ7
#endif
#ifdef uSBC
#define CONFIG_MX6S_SECO_uSBC
#endif
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"setvideomode=setenv videomode video=mxcfb0:dev=hdmi,1920x1080M@60,if=RGB24,bpp=32 video=mxcfb1:dev=ldb,${lvdsres1}\0"	\
...
#ifdef UQSEVEN
	#define CONFIG_SYS_PROMPT		"MX6SOLO SECO_uQ7 U-Boot > "
#elif defined(QSEVEN)
	#define CONFIG_SYS_PROMPT		"MX6SOLO SECO_Q7 U-Boot > "
#elif defined(uSBC)
	#define CONFIG_SYS_PROMPT		"MX6SOLO SECO_uSBC U-Boot > "
#else
	#define CONFIG_SYS_PROMPT		"MX6SOLO SECO U-Boot > "
#endif
...
#define CONFIG_FASTBOOT_PRODUCT_NAME_STR "i.mx6dl SECO SmartDevice"
